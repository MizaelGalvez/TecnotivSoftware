...
START TRANSACTION;
USE `DBTecnotiv`;
INSERT INTO `DBTecnotiv`.`Configuracion` (`idConfiguracion`, `lbl_idioma`, `uso_silla`, `uso_diadema`, `uso_Mause`, `uso_Sensor`, `lbl_Usuario`) VALUES (1, 1, 0, 0, 1, 0, 'Desarrolladores :)');
